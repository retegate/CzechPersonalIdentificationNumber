...
internal static class MaleWithExceptionalMonthRule2004AndLatterCzechPersonalIdentificationNumberValidationExtension
{
    /// <summary>
    ...
    /// </returns>
    public static IRuleBuilderOptions<T, string> MaleWithExceptionalMonthRule2004AndLatterCzechPersonalIdentificationNumber<T>(this IRuleBuilder<T, string> ruleBuilder)
    {
        var result = ruleBuilder
            .Custom((personalIdentificationNumber, context) =>
            {
                try
                {
                    _ = CzechPersonalIdentificationNumber.ParserHypothesis.MaleWithExceptionalMonthRule2004AndLatterCzechPersonalIdentificationNumber.Parse(personalIdentificationNumber);
                }
