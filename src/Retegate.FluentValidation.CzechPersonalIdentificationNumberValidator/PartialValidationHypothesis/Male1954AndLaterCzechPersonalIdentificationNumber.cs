...
internal static class Male1954AndLaterCzechPersonalIdentificationNumberValidationExtension
{
    /// <summary>
    ...
    /// </returns>
    public static IRuleBuilderOptions<T, string> Male1954AndLaterCzechPersonalIdentificationNumber<T>(this IRuleBuilder<T, string> ruleBuilder)
    {
        var result = ruleBuilder
            .Custom((personalIdentificationNumber, context) =>
            {
                try
                {
                    _ = CzechPersonalIdentificationNumber.ParserHypothesis.Male1954AndLaterCzechPersonalIdentificationNumber.Parse(personalIdentificationNumber);
                }
