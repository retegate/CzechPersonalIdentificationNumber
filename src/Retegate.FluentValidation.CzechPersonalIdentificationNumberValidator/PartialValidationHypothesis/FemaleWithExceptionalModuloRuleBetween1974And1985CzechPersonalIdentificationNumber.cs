...
internal static class FemaleWithExceptionalModuloRuleBetween1974And1985CzechPersonalIdentificationNumberValidationExtension
{
    /// <summary>
    ...
    /// </returns>
    public static IRuleBuilderOptions<T, string> FemaleWithExceptionalModuloRuleBetween1974And1985CzechPersonalIdentificationNumber<T>(this IRuleBuilder<T, string> ruleBuilder)
    {
        var result = ruleBuilder
            .Custom((personalIdentificationNumber, context) =>
            {
                try
                {
                    _ = CzechPersonalIdentificationNumber.ParserHypothesis.FemaleWithExceptionalModuloRuleBetween1974And1985CzechPersonalIdentificationNumber.Parse(personalIdentificationNumber);
                }
